---
title: "Ley 21.719 de Protección de Datos Personales: guía 2026 para pymes chilenas (qué cambia, qué hacer y cómo no caer en multas de hasta 20.000 UTM)"
description: "Guía práctica 2026 para pymes en Chile: qué exige la nueva Ley 21.719 que entra en vigencia el 1 de diciembre de 2026. Plazos, multas, derechos ARCO, DPO, EIPD y checklist de cumplimiento. Para empresas en Santiago, Maule, O'Higgins, Ñuble, Biobío y todo Chile."
pubDate: 2026-05-18T08:00:00-04:00
author: "Darío Ramírez"
readingTime: "13 min"
heroAlt: "Infografía Ley 21.719 de Protección de Datos Personales en Chile 2026: fechas clave, multas hasta 20.000 UTM y siete obligaciones para pymes"
heroImage: "/blog/ley-21719-cumplimiento-pymes-chile-2026.svg"
images:
  - url: "/blog/ley-21719-cumplimiento-pymes-chile-2026.svg"
    title: "Ley 21.719 Chile 2026: cumplimiento para pymes en un vistazo"
    caption: "Fechas, sanciones y obligaciones de la nueva Ley de Protección de Datos Personales para empresas chilenas."
tags: ["Ley 21.719", "protección de datos", "datos personales", "pymes Chile", "cumplimiento", "Agencia de Protección de Datos", "DPO", "EIPD", "Santiago", "Maule", "O'Higgins", "Ñuble", "Biobío"]
relatedPosts: ["ley-21719-inteligencia-artificial-empresas-chile-2026", "ley-21719-datos-sensibles-sectores-chile-2026", "framework-ia-pymes-chile", "fondos-financiamiento-ia-empresas-chile-2026"]
---
...
Esto implica tener procedimiento documentado: cómo detectas, cómo escalas, quién notifica, qué se comunica. Aunque nunca te pase, debes tenerlo listo. Recomendación: integra esto con tu plan de continuidad y ciberseguridad bajo la [Ley 21.663 de Ciberseguridad](https://www.bcn.cl/leychile/navegar?idNorma=1207220).

### 6. Derechos ARCO + portabilidad + oposición a decisiones automatizadas

El titular puede pedir:

- **A**cceso: copia de sus datos.
- **R**ectificación: corregir lo erróneo.
- **C**ancelación / supresión: que borres sus datos.
- **O**posición: detener el tratamiento (especialmente marketing).
...
Implementación práctica: crea un correo o formulario tipo `privacidad@tuempresa.cl` con un proceso documentado para gestionar estas solicitudes.
...
La mayoría de proveedores grandes ya tiene un DPA estándar disponible en sus webs (ver por ejemplo el [Anexo de Tratamiento de Datos de OpenAI](https://openai.com/policies/data-processing-addendum/) o el de [Anthropic](https://www.anthropic.com/legal/dpa)). Tu tarea: localizarlos, firmar, archivar.
...
La ley se publicó en diciembre 2024 pero la Agencia se constituye y entra plenamente en operación con la vigencia el 1 de diciembre de 2026. La etapa previa la está liderando el Ministerio de Hacienda y la [Secretaría de Gobierno Digital](https://wikiguias.digital.gob.cl/datos-personales/guia-practica-implementacion-nueva-ley-datos-personales).
...
Sí. CORFO Digitalización Pyme y SERCOTEC CRECE pueden cubrir parte del costo de adecuación tecnológica (CRM con módulo de consentimiento, herramientas de seguridad, software DPO). Ver nuestra guía de [fondos para proyectos de IA y digitalización 2026](/blog/fondos-financiamiento-ia-empresas-chile-2026/).

## Fuentes oficiales

- [Ley 21.719 — Biblioteca del Congreso Nacional (BCN)](https://www.bcn.cl/leychile/navegar?idNorma=1209272)
...
- [Ley 21.663 de Ciberseguridad (complementaria) — BCN](https://www.bcn.cl/leychile/navegar?idNorma=1207220)
- [Sitio Agencia de Protección de Datos Personales (en construcción)](https://www.gob.cl)
...
**[Conversar con nosotros por WhatsApp →](https://wa.me/56945262335?text=Hola%2C%20quiero%20asesor%C3%ADa%20para%20cumplir%20la%20Ley%2021.719%20en%20mi%20pyme)**
